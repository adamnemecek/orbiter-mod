...
typedef class action_on_subspaces action_on_subspaces;
...
public:
	...
	//void get_strong_generators(vector_ge *gens, INT *tl, INT verbose_level);
	...
	//void eliminate_redundant_base_points(INT verbose_level);
	...
	void induced_action_on_grassmannian(action *A_old,
		...
		INT f_induce_action, sims *old_G,
		INT verbose_level);
    void induced_action_on_subspaces(action *A_old,
		action_on_subspaces *Asub,
		INT f_induce_action, sims *old_G,
		INT verbose_level);
...
public:
  ...
  INT low_level_point_size;
	...
	void null();
	void free();
	void init(action &A, subspaces *G, INT verbose_level);
	INT compute_image_INT(action *A, INT *Elt,
		INT i, INT verbose_level);
};
