	...
	INT xmax, INT ymax, INT rad, INT f_embedded, INT verbose_level)
{
	...
	if (file_size(fname1)) {
		...
		draw_tree_low_level(fname, nb_nodes, 
			...
			xmax, ymax, rad, f_embedded, 0 /*verbose_level - 2*/);
...
#endif
	mp_graphics G;
	G.setup(fname, x_min, y_min, x_max, y_max, xmax, ymax, f_embedded, scale, line_width);
	//G.frame(0.05);
...
void generator::draw_poset_full(const BYTE *fname_base, INT depth, INT data, INT f_embedded, INT verbose_level)
{
	INT f_v = (verbose_level >= 1);
	layered_graph *LG;
	...
	LG->draw(fname_base1, xmax, ymax, x_max, y_max, rad, f_circle, f_corners, f_nodes_empty, 
		FALSE, 0, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
		FALSE, NULL, f_show_level_info, f_embedded, f_label_edges, 
		scale, line_width
		);
	if (f_v) {
...
void generator::draw_poset(const BYTE *fname_base, INT depth, INT data, INT f_embedded, INT verbose_level)
{
	INT f_v = (verbose_level >= 1);
	layered_graph *LG1;
	layered_graph *LG2;
	...
	LG1->draw(fname_base1, xmax, ymax, x_max, y_max, rad, f_circle, f_corners, f_nodes_empty, 
		FALSE, 0, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
	...
	LG2->draw(fname_base2, xmax, ymax, x_max, y_max, rad, f_circle, f_corners, f_nodes_empty, 
		FALSE, 0, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
	...
	LG3->draw(fname_base3, xmax, ymax, x_max, y_max, rad, f_circle, f_corners, f_nodes_empty, 
		FALSE, 0, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
	...
	LG4->draw(fname_base4, xmax, ymax, x_max, y_max, rad, f_circle, f_corners, f_nodes_empty, 
		FALSE, 0, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
		FALSE, NULL, 
...
void generator::draw_level_graph(const BYTE *fname_base, INT depth, INT data, INT level, INT f_embedded, INT verbose_level)
{
	INT f_v = (verbose_level >= 1);
	layered_graph *LG;
