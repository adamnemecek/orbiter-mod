...
INT finite_field::dot_product(INT len, INT *v, INT *w, INT verbose_level)
{
	INT f_v = (verbose_level >= 1);
	INT i, a = 0, b;
	
	if (f_v) {
		cout << "finite_field::dot_product: <";
