	...
	INT verbose_level)
{
	...
	if (f_v) {
		...
		cout << "compute_lifts verbose_level=" << verbose_level << endl;
		}
	...
	if (f_v) {
		cout << "compute_lifts before compute_liftings" << endl;
		}

	E->compute_liftings(f_solve, f_save, f_read_instead, 
