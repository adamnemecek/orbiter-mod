...
public:
	...
	void init(INT n, INT f_draw, INT verbose_level);
...
int main(int argc, char **argv)
{
	...
	H.init(n, f_draw, verbose_level);

	the_end(t0);

}

void hadamard::init(INT n, INT f_draw, INT verbose_level)
{
	...
	CG->init(N, 1, color, bitvector_adjacency, verbose_level);
